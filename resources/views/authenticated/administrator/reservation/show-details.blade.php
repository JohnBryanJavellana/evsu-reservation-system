...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <a href="/welcome/administrator/reservations" class="btn btn-default btn-sm">
                        ...
                        <div class="card card-outline card-danger rounded-0">
                            <div class="card-body chart">
                                <div class="alert alert-light rounded-0 small">
                                    ...
                                    ID#{{ $reservation->id }}
                                    <div class="w-100"><strong>Rented by:</strong> {{ $reservation->rented_by->firstname . ' ' . $reservation->rented_by->middlename . ' ' . $reservation->rented_by->lastname . ' ' . $reservation->rented_by->suffix }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 text-bold text-right text-danger">
                                        ...
                                        <select onchange="changeStatus({{ $reservation->id }})" class="form-control form-control-sm">
                                            ...
                                            <option @if($reservation->status == "confirmed") selected @endif value="confirmed">Confirmed</option>
                                            <option @if($reservation->status == "cancelled") selected @endif value="cancelled">Cancelled</option>
                                            <option @if($reservation->status == "completed") selected @endif value="completed">Completed</option>
                                        </select>
                                        @else
                                            COMPLETED
                                        @endif
    ...
    <script>
        function changeStatus(id){
            ...
            window.location.href = "/welcome/administrator/reservations/info/" + id + "/updateStatus/" + val;
        }
